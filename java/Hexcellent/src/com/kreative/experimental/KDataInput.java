...
public class KDataInput implements DataInput {
	private final DataInput in;
	public KDataInput(DataInput in) { this.in = in; }
	...
	public BigInteger readSignedBEB128() throws IOException { return readBEB128(true); }
	public BigInteger readUnsignedBEB128() throws IOException { return readBEB128(false); }
	private BigInteger readBEB128(boolean signed) throws IOException {
		byte b = in.readByte();
		byte s = (byte)(b & 0x7F);
	...
	public BigInteger readSignedLEB128() throws IOException { return readLEB128(true); }
	public BigInteger readUnsignedLEB128() throws IOException { return readLEB128(false); }
	private BigInteger readLEB128(boolean signed) throws IOException {
		int shift = 0;
		byte b = in.readByte();
		byte s = (byte)(b & 0x7F);
	...
	public Number readLEFP128() throws IOException { return readFP128(true); }
	public Number readBEFP128() throws IOException { return readFP128(false); }
	private Number readFP128(boolean le) throws IOException {
