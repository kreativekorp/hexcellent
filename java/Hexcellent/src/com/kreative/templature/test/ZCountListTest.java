...
public class ZCountListTest extends AbstractUITest {
	public String getTitle() {
		return "ZCNT LSTC Test";
	}
	...
	public TemplateItem createItem() {
		...
		t2.add(new CountedListBlock(0, 0, 0, "", "", "The Count", "#####", "*****", false, 8, -1, t1));
		
		return t2;
	}
	
	public static void main(String[] args) {
		new ZCountListTest().main();
	}
}
