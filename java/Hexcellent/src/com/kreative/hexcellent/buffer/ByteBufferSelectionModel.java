...
public class ByteBufferSelectionModel {
	...
	public long getSelectionStart() { return start; }
	public long getSelectionEnd() { return end; }
	public long getSelectionMin() { return Math.min(start, end); }
	public long getSelectionMax() { return Math.max(start, end); }
	public long getSelectionLength() { return Math.abs(start - end); }
	public boolean isMidByte() { return midbyte; }
	...
	protected final void fireSelectionChanged(long start, long end) {
		for (ByteBufferSelectionListener l : listeners) l.selectionChanged(this, start, end);
	}
}
